package com.lee.loollool.adapter;
...
import com.lee.loollool.main_activities.Tab1Activity;
...
public class ComplexListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        titleTxt1.setText(item.get(Tab1Activity.ITEM_TITLE_1));
        titleTxt2.setText(item.get(Tab1Activity.ITEM_TITLE_2));
        titleTxt3.setText(item.get(Tab1Activity.ITEM_TITLE_3));

        if (item.getInteger(Tab1Activity.ITEM_IMAGE_1) != -1) {
            iv1.setImageResource(item.getInteger(Tab1Activity.ITEM_IMAGE_1));
        }
        if (item.getInteger(Tab1Activity.ITEM_IMAGE_2) != -1) {
            iv2.setImageResource(item.getInteger(Tab1Activity.ITEM_IMAGE_2));
        }
        if (item.getInteger(Tab1Activity.ITEM_IMAGE_3) != -1) {
            iv3.setImageResource(item.getInteger(Tab1Activity.ITEM_IMAGE_3));
        ...
        OnClickListener l1 = new OnClickListener() {
            ...
            public void onClick(View arg0) {
                delegate.openExample(item.getInteger(Tab1Activity.ITEM_INDEX_1));
            }
        };
        ...
        OnClickListener l2 = new OnClickListener() {
            ...
            @Override
            public void onClick(View arg0) {
                delegate.openExample(item.getInteger(Tab1Activity.ITEM_INDEX_2));
            }
        };
        ...
        OnClickListener l3 = new OnClickListener() {
            ...
            @Override
            public void onClick(View arg0) {
                delegate.openExample(item.getInteger(Tab1Activity.ITEM_INDEX_3));
            }
        };
