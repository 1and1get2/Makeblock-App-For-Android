...
public class MeModule {
    ...
    public static final int DEV_LCD = 30;
    public static final int DEV_FENGMINGQI = 43;

    public static final int DEV_NO = 100;
    ...
    private static MeModule instance;

    public static MeModule getContext() {
    ...
    public void setScaleType(int type) {
        if (type == 1 || type == 40) {
            yPosition = (int) (yPosition * Tab1Activity.screenWidth / 1196.0);
            xPosition = (int) (xPosition * (Tab1Activity.screenHeight - 120) / 600.0);
        }
        update();
    }
    ...
    static public byte[] WriteLCD(int lcdlen, byte len, byte lin, byte[] date) {
        Log.d("len", String.valueOf(len));
        Log.d("len", String.valueOf(lcdlen));
        byte[] cmd = new byte[lcdlen];
        cmd[0] = (byte) 0xff;
        cmd[1] = (byte) 0x55;
        cmd[2] = len;
        cmd[3] = (byte) 0;
        ...
        cmd[6] = (byte) 0x00;
        cmd[7] = lin;
        Log.d("len", String.valueOf(date.length));
